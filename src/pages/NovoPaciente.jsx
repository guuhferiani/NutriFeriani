...
const NovoPaciente = () => {
  ...
  const handleMultiSelect = (name, value) => {
    setFormData(prev => {
      let current = [...prev[name]];
      
      if (value === 'Nenhum') {
        return { ...prev, [name]: ['Nenhum'] };
      }
      
      // Se selecionou algo diferente de Nenhum, remove o Nenhum se ele estiver lá
            ...
            {activeTab === 'pessoal' && (
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <input type="text" name="telefone" value={formData.telefone} onChange={handleChange} placeholder="(00) 0000-0000" />
                </div>
                <div className="form-group">
              ...
              <div className="form-grid">
                ...
                <div className="form-group form-full">
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    <input type="text" value={imc || '--'} readOnly style={{ width: '100px', textAlign: 'center', background: '#f1f5f9' }} />
                ...
                <div className="form-group form-full">
                  ...
                  <div className="checkbox-group">
                    <label className="checkbox-item">
                      <input type="checkbox" checked={formData.patologias.includes('Nenhum')} onChange={() => handleMultiSelect('patologias', 'Nenhum')} />
                      Nenhum
                    </label>
                  ...
                  <textarea name="patologias_texto" value={formData.patologias_texto} onChange={handleChange} placeholder="Outras patologias ou detalhes..." style={{ marginTop: '0.75rem' }} />
                </div>
                ...
                <div className="form-group form-full">
                  ...
                  <div className="checkbox-group">
                    <label className="checkbox-item">
                      <input type="checkbox" checked={formData.restricoes_alimentares.includes('Nenhum')} onChange={() => handleMultiSelect('restricoes_alimentares', 'Nenhum')} />
                      Nenhum
                    </label>
                  ...
                  <textarea name="restricoes_texto" value={formData.restricoes_texto} onChange={handleChange} placeholder="Outras restrições ou detalhes..." style={{ marginTop: '0.75rem' }} />
                </div>
                ...
                <div className="form-group form-full">
                  ...
                  <div className="checkbox-group">
                    <label className="checkbox-item">
                      <input type="checkbox" checked={formData.alergias.includes('Nenhum')} onChange={() => handleMultiSelect('alergias', 'Nenhum')} />
                      Nenhum
                    </label>
                  ...
                  <textarea name="alergias_texto" value={formData.alergias_texto} onChange={handleChange} placeholder="Outras alergias ou detalhes..." style={{ marginTop: '0.75rem' }} />
                </div>
