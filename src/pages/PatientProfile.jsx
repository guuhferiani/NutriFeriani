...
const PatientProfile = () => {
  ...
  const formatTimeInput = (value) => {
    ...
    if (clean.length === 3) {
      return '0' + clean.slice(0, 1) + ':' + clean.slice(1);
    }
    if (clean.length === 4) {
  ...
  const savePatientChanges = async () => {
    try {
      ...
      // Limpar dados (converter strings vazias para null para evitar erros de tipo)
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                      <input type="date" name="data_nascimento" value={formData.data_nascimento || ''} onChange={handlePatientChange} style={{ flex: 1 }} />
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" name="telefone" value={formData.telefone || ''} onChange={handlePatientChange} placeholder="(00) 0000-0000" />
                  </div>
                  <div className="form-group">
                    <label>WhatsApp</label>
                    <input type="text" name="whatsapp" value={formData.whatsapp || ''} onChange={handlePatientChange} placeholder="(00) 00000-0000" />
                  </div>
                  <div className="form-group form-full">
                    <label>E-mail</label>
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group form-full">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <input type="text" value={imc || '--'} readOnly style={{ width: '100px', textAlign: 'center', background: '#f1f5f9', borderRadius: '0.75rem', border: '1px solid var(--border)', padding: '0.75rem' }} />
                  ...
                  <div className="form-group form-full">
                    ...
                    <textarea name="objetivo_texto" value={formData.objetivo_texto || ''} onChange={handlePatientChange} placeholder="Outros objetivos ou detalhes..." style={{ marginTop: '1rem' }} />
                  </div>
                  ...
                  <div className="form-group form-full">
                    ...
                    <div className="checkbox-group">
                      {nivelAtividadeOptions.map(opt => (
                        <label key={opt} className="checkbox-item">
                          <input type="radio" name="nivel_atividade" value={opt} checked={formData.nivel_atividade === opt} onChange={handlePatientChange} style={{ width: '1.25rem', height: '1.25rem', accentColor: 'var(--primary)' }} />
                          {opt}
                        </label>
                      ))}
                    </div>
                  ...
                  <div className="form-group form-full">
                    ...
                    <textarea name="patologias_texto" value={formData.patologias_texto || ''} onChange={handlePatientChange} placeholder="Outras patologias ou detalhes..." style={{ marginTop: '0.75rem' }} />
                  </div>
                  ...
                  <div className="form-group form-full">
                    ...
                    <textarea name="restricoes_texto" value={formData.restricoes_texto || ''} onChange={handlePatientChange} placeholder="Outras restrições ou detalhes..." style={{ marginTop: '0.75rem' }} />
                  </div>
                  ...
                  <div className="form-group form-full">
                    ...
                    <textarea name="alergias_texto" value={formData.alergias_texto || ''} onChange={handlePatientChange} placeholder="Outras alergias ou detalhes..." style={{ marginTop: '0.75rem' }} />
                  </div>

                  <div className="form-group">
                    <label>Medicamentos Contínuos</label>
                    <textarea name="medicamentos" value={formData.medicamentos || ''} onChange={handlePatientChange} placeholder="Liste os medicamentos..." />
                  </div>
                  <div className="form-group">
                    <label>Suplementos em uso</label>
                    <textarea name="suplementos" value={formData.suplementos || ''} onChange={handlePatientChange} placeholder="Liste os suplementos..." />
                  </div>
                </div>
              )}
              ...
              {activeTab === 'habitos' && (
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" name="horario_acorda" value={formData.horario_acorda || ''} onChange={handlePatientChange} onBlur={() => handleBlurTime('horario_acorda')} placeholder="Ex: 6 ou 06:30" />
                  </div>
                  <div className="form-group">
                    <label>Horário que dorme</label>
                    <input type="text" name="horario_dorme" value={formData.horario_dorme || ''} onChange={handlePatientChange} onBlur={() => handleBlurTime('horario_dorme')} placeholder="Ex: 23 ou 22:30" />
                  </div>
                  <div className="form-group form-full">
                    ...
                    {formData.atividade_fisica && (
                      <textarea name="atividade_fisica_descricao" value={formData.atividade_fisica_descricao || ''} onChange={handlePatientChange} placeholder="Qual atividade e frequência semanal?" style={{ marginTop: '0.5rem' }} />
                    )}
                  </div>
                  <div className="form-group form-full">
                    <label>Observações Gerais</label>
                    <textarea name="observacoes" value={formData.observacoes || ''} onChange={handlePatientChange} placeholder="Detalhes adicionais..." />
                  </div>
                </div>
              )}
          ...
          <section className="profile-section">
            <div className="section-header">
              ...
              <button 
                ...
                onClick={() => alert('Funcionalidade de gerar plano será implementada em breve.')}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
